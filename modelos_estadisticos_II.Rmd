...
* ¿y si las observaciones fueron tomadas en plots de diferentes areas? Por definición, en plots de áreas más grandes (e.g. 1m²) será más probable observar seedlings que en plots más pequeños (e.g. 0.25m²).
...
* Otro ejemplo: número de casos de cáncer en cuatro ciudades danesas. Cada ciudad tiene un tamaño diferente, por lo que tiene sentido modelar la media de casos observados *en función del tamaño de la población*.
